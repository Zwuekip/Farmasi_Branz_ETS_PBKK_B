...
NXT:
    ...
    Private Sub lbltransactionno_Click(sender As Object, e As EventArgs) Handles lbltransactionno.Click

    End Sub

    Private Sub frmcashregistry_Load(sender As Object, e As EventArgs) Handles MyBase.Load
